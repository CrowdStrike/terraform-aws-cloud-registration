...
| <a name="input_aws_role_arn"></a> [aws\_role\_arn](#input\_aws\_role\_arn) | ARN of the IAM Role to assume for region providers | `string` | n/a | yes |
...
| <a name="input_is_gov"></a> [is\_gov](#input\_is\_gov) | Set to true if registering in gov-cloud | `bool` | n/a | yes |
...
| <a name="input_sts_region"></a> [sts\_region](#input\_sts\_region) | (Optional) AWS Region for STS. If unset, AWS will use the same Region for STS as other non-STS operations | `string` | `null` | no |
